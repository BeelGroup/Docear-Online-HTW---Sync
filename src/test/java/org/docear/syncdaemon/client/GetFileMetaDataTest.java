...
public class GetFileMetaDataTest {
	...
	public void testGetFileMetaData() {
		...
		final FileMetaData metadata = clientService.getCurrentFileMetaData(user, new FileMetaData("507f191e810c19729de860ea", "/README.md", false));
	...
	public void testFileNotPresent() {
		final Daemon deamon = TestUtils.daemonWithService(ClientService.class, ClientServiceImpl.class);
		final ClientService clientService = deamon.service(ClientService.class);
		final FileMetaData metadata = clientService.getCurrentFileMetaData(user, new FileMetaData("507f191e810c19729de860ea", "/NOT PRESENT", false));
